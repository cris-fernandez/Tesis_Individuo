...
pairwise.adonis(x=norm_aa_target[,2:8],factors=norm_aa_target$spot_status,sim.function='dist',
                        sim.method='euclidean',p.adjust.m='bonferroni') #se puede usar vegdist en vez de dist

pairwise.adonis(x=norm_ps_target[,2:8],factors=norm_ps_target$spot_status,sim.function='vegdist',
                        sim.method='euclidean',p.adjust.m='bonferroni')

pairwise.adonis(x=norm_pp_target[,2:8],factors=norm_pp_target$spot_status,sim.function='vegdist',
                        sim.method='euclidean',p.adjust.m='bonferroni')
