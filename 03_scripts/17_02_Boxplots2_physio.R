...
d18o_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = leaf_d18o, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
tiff("04_figures/17_02_All_physio2_boxplots.tiff", units = "mm", width = 300, height = 700,
     res = 400, compression = "lzw")
wc_box / chl_box / chlab_box / xc_box / chlxc_box / d13c_box / d15n_box / d18o_box
dev.off()

tiff("04_figures/17_02_Select_physio2_boxplots.tiff", units = "mm", width = 300, height = 500,
     res = 400, compression = "lzw")
