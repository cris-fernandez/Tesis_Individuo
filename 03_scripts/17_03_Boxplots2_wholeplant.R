...
bai80_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = mean_1980, fill = spot_status),
...
bai05_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = mean_05, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
rt12_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = Rt12, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
rt17_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = Rt17, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
rt22_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = Rt22, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
rs12_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = Rs12, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
rs17_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = Rs17, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
tiff("04_figures/17_03_All_wholeplant2_boxplots.tiff", units = "mm", width = 300, height = 700,
     res = 400, compression = "lzw")
bai80_box / bai05_box / rt12_box / rt17_box / rt22_box / rs12_box / rs17_box
dev.off()

tiff("04_figures/17_03_Select_wholeplant2_boxplots.tiff", units = "mm", width = 300, height = 500,
     res = 400, compression = "lzw")
