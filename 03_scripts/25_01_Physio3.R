...
d18o_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = leaf_d18o_corrected, fill = vigor_id),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("hot_healthy", "hot_damaged"),
                    values = c("hot_healthy" = "#D71515",
                               "hot_damaged" = "#650304"),
...
tiff("04_figures/25_01_All_physio3.tiff", units = "mm", width = 400, height = 400,
...
tiff("04_figures/25_02_Select_physio3.tiff", units = "mm", width = 300, height = 300,
     res = 400, compression = "lzw")
