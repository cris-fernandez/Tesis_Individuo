...
tiff("04_figures/18_02_All_physio2_scatterplots.tiff", units = "mm", width = 400, height = 700,
...
tiff("04_figures/18_02_Select_physio2_scatterplots.tiff", units = "mm", width = 400, height = 400,
     res = 400, compression = "lzw")
wc_all + plot_spacer() + wc_aa + wc_ps + wc_pp + 
