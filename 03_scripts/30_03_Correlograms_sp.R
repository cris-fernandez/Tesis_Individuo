...
tiff("04_figures/30_04_correlogram_aa.tiff", units = "mm", 
     width = 300, height = 300,
     res = 700, compression = "lzw")
correlogram_aa2
dev.off()

tiff("04_figures/30_05_correlogram_ps.tiff", units = "mm", 
     width = 300, height = 300,
     res = 700, compression = "lzw")
correlogram_ps2
dev.off()

tiff("04_figures/30_06_correlogram_pp.tiff", units = "mm", 
     width = 300, height = 300,
     res = 700, compression = "lzw")
correlogram_pp2
dev.off()
