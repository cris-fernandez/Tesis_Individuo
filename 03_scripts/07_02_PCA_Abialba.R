...
biplot_all <- ggplot() +
  ...
  scale_fill_gradientn(colours = c(scales::alpha("#746fb2", 0),
                                   scales::alpha("#746fb2", 0.4))) +
  geom_contour(data = dens_df,
               ...
               size = 0.7,
               linetype = "dashed") + 
  geom_point(data = pca_df, aes(x = Comp.1, y = Comp.2), color = "#746fb2", 
             alpha = 0.6) +
...
tiff("04_figures/07_02_pca_abialba.tiff", units = "mm", 
