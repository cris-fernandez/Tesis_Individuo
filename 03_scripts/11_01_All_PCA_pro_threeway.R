...
box_height <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = height, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    ...
                    labels = c("A. alba",
                               ...
                               "All"),
                    name = "") +
  scale_alpha_manual(breaks = c("cold_healthy", "hot_healthy", "hot_damaged"),
                     values = c("hot_healthy" = 0.5, "hot_damaged" = 0.2,
                                "cold_healthy" = 1),
                     name = "") + 
  guides(alpha = "none") +
  labs(tag = "A") +
...
box_dbh <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = dbh, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_age <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = age, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_hegyi <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = hegyi_index, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_sla <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = sla_22, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_c <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = percent_c, fill = sp_id, alpha = vigor_id)) + 
...
box_defo <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = mean_def_obs, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_wc <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = wc_22, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_chl_fw <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = total_chl_fw_22, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_n <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = percent_n, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02"),
...
box_chl_a <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = chlor_a_22, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_chl_b <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = chlor_b_22, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_chl_ab <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = chla_chlb_22, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_d13c <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = d13c, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02"),
...
box_xc_fw <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = xc_fw_22, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_chl_xc <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = chl_xc_22, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_cn <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = cn_ratio, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_d13c <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = leaf_d13c, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_d15n <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = leaf_d15n, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_d18o <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = leaf_d18o, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_bai <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = mean_bai, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_bai80 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = mean_1980, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_bai20 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = mean_20, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_bai15 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = mean_15, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_bai10 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = mean_10, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_bai05 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = mean_05, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_rt12 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = Rt12, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_rt17 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = Rt17, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_rt22 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = Rt22, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_rs12 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = Rs12, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_rs17 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = Rs17, fill = sp_id, alpha = vigor_id)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
tiff("04_figures/11_01_all_boxplots3.tiff", units = "mm", width = 800, height = 800,
