...
aa_cold <- clean_target %>% filter(sp_id == "Abialba" & spot_status == "coldspot") %>% dplyr::select(-c(sp_id, spot_status))
aa_hot <- clean_target %>% filter(sp_id == "Abialba" & spot_status == "hotspot") %>% dplyr::select(-c(sp_id, spot_status))

ps_cold <- clean_target %>% filter(sp_id == "Pinsylv" & spot_status == "coldspot") %>% dplyr::select(-c(sp_id, spot_status))
ps_hot <- clean_target %>% filter(sp_id == "Pinsylv" & spot_status == "hotspot") %>% dplyr::select(-c(sp_id, spot_status))

pp_cold <- clean_target %>% filter(sp_id == "Pinpine" & spot_status == "coldspot") %>% dplyr::select(-c(sp_id, spot_status))
pp_hot <- clean_target %>% filter(sp_id == "Pinpine" & spot_status == "hotspot") %>% dplyr::select(-c(sp_id, spot_status))
...
tiff("04_figures/99_99_Correlos_site.tiff",
