...
tiff("04_figures/30_07_correlogram_aa.tiff", units = "mm", 
     width = 200, height = 200,
     res = 700, compression = "lzw")
correlogram_aa2
dev.off()

tiff("04_figures/30_07_correlogram_ps.tiff", units = "mm", 
     width = 200, height = 200,
     res = 700, compression = "lzw")
correlogram_ps2
dev.off()

tiff("04_figures/30_07_correlogram_pp.tiff", units = "mm", 
     width = 200, height = 200,
     res = 700, compression = "lzw")
correlogram_pp2
dev.off()
