...
tiff("04_figures/13_04_Predisposing_Pinpine_boxplots.tiff", units = "mm", width = 300, height = 300,
     res = 400, compression = "lzw")
box_age + box_hegyi + box_bai80 + box_rs12 + 
  plot_layout(guides = 'collect', ncol = 2) + 
  plot_annotation("Pinus pinea",
                  theme = theme(plot.title = element_text(hjust = 0.5,
                                                          size = 40)))
dev.off()

tiff("04_figures/13_04_Response_Pinpine_boxplots.tiff", units = "mm", width = 400, height = 300,
     res = 400, compression = "lzw")
