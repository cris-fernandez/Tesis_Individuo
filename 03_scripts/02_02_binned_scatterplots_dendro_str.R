...
bai_height <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = height_cat, y = mean, fill = sp_id, alpha = spot_status)) + 
...
bai80_height <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = height_cat, y = mean_1980, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai20_height <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = height_cat, y = mean_20, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai15_height <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = height_cat, y = mean_15, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai10_height <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = height_cat, y = mean_10, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai05_height <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = height_cat, y = mean_05, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai_dbh <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = dbh_cat, y = mean, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai80_dbh <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = dbh_cat, y = mean_1980, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai20_dbh <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = dbh_cat, y = mean_20, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai15_dbh <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = dbh_cat, y = mean_15, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai10_dbh <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = dbh_cat, y = mean_10, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai05_dbh <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = dbh_cat, y = mean_05, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai_hegyi <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = hegyi_cat, y = mean, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai80_hegyi <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = hegyi_cat, y = mean_1980, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai20_hegyi <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = hegyi_cat, y = mean_20, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai15_hegyi <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = hegyi_cat, y = mean_15, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai10_hegyi <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = hegyi_cat, y = mean_10, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai05_hegyi <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = hegyi_cat, y = mean_05, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai_age <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = age_cat, y = mean, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai80_age <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = age_cat, y = mean_1980, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai20_age <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = age_cat, y = mean_20, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai15_age <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = age_cat, y = mean_15, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai10_age <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = age_cat, y = mean_10, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
...
bai05_age <- ggplot(clean_target2) + 
  geom_boxplot(aes(x = age_cat, y = mean_05, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77"),
                    labels = c("A. alba",
