...
wc_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = wc_22), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = wc_22), col = "red", fill = "red",
...
chlab_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = chla_chlb_22), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = chla_chlb_22), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "C") +
  ylab("Chl. a/b") + 
  spot_scale
...
xc_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = xc_fw_22), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = xc_fw_22), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "D") +
...
chlxc_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = chl_xc_22), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = chl_xc_22), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "E") +
  ylab("Chl. / car.") + 
  spot_scale
...
d13c_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = leaf_d13c), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = leaf_d13c), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "F") +
  ylab(bquote("δ"~C^13~"(‰)")) + 
  spot_scale
...
d15n_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = leaf_d15n), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = leaf_d15n), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "G") +
  ylab(bquote("δ"~N^15~"(‰)")) + 
  spot_scale + 
...
d18o_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = leaf_d18o), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = leaf_d18o), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "H") +
  ylab(bquote("δ"~O^18~"(‰)")) + 
  spot_scale + 
