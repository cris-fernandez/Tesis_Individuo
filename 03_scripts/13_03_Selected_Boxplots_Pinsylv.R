...
tiff("04_figures/13_03_Predisposing_Pinsylv_boxplots.tiff", units = "mm", width = 300, height = 300,
...
tiff("04_figures/13_03_Response_Pinsylv_boxplots.tiff", units = "mm", width = 400, height = 300,
     res = 400, compression = "lzw")
