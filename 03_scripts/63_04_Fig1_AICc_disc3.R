...
fig_bai80 <- ggplot(bai80_df) + 
  ...
  scale_color_manual(breaks = c("hot_healthy", "hot_damaged"),
                     ...
                     labels = c("Healthy",
                                "Damaged"),
                     name = "") + 
  scale_x_discrete(labels = c("Abialba" = "Abies alba",
  ...
  theme_classic() + 
  theme(axis.text.x = element_text(size = 30, vjust = -1,
                                   face = "italic"),
        axis.ticks.x = element_blank(),
        axis.text.y = element_text(size = 20),
        axis.title.y = element_text(size = 30),
...
fig_h / fig_sla / fig_n / fig_chl / fig_xc / 
  fig_d13c / fig_bai80 / guide_area() +
