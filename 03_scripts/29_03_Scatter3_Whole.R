...
bai80_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = mean_1980, color = vigor_id)) + 
  geom_smooth(aes(x = mean_def_obs, y = mean_1980, col = vigor_id, fill = vigor_id),
...
bai05_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = mean_05, color = vigor_id)) + 
  geom_smooth(aes(x = mean_def_obs, y = mean_05, col = vigor_id, fill = vigor_id),
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "B") +
...
rt12_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = Rt12, color = vigor_id)) + 
  geom_smooth(aes(x = mean_def_obs, y = Rt12, col = vigor_id, fill = vigor_id),
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "C") +
  ylab("Rt 2012") + 
  spot_scale
...
rt17_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = Rt17, color = vigor_id)) + 
  geom_smooth(aes(x = mean_def_obs, y = Rt17, col = vigor_id, fill = vigor_id),
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "D") +
  ylab("Rt 2017") + 
  spot_scale
...
rt22_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = Rt22, color = vigor_id)) + 
  geom_smooth(aes(x = mean_def_obs, y = Rt22, col = vigor_id, fill = vigor_id),
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "E") +
  ylab("Rt 2022") + 
  spot_scale
...
rs12_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = Rs12, color = vigor_id)) + 
  geom_smooth(aes(x = mean_def_obs, y = Rs12, col = vigor_id, fill = vigor_id),
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "F") +
  ylab("Rs 2012") + 
  spot_scale
...
rs17_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = Rs17, color = vigor_id)) + 
  geom_smooth(aes(x = mean_def_obs, y = Rs17, col = vigor_id, fill = vigor_id),
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "G") +
  ylab("Rs 2017") + 
  spot_scale + 
...
tiff("04_figures/29_03_Scatter_whole3.tiff", units = "mm", width = 400, height = 400,
...
tiff("04_figures/29_04_Scatter_whole3_select.tiff", units = "mm", width = 300, height = 300,
     res = 400, compression = "lzw")
