...
loadings_df_cold$varnames <- c("Height", "dbh", 
...
loadings_df_hot$varnames <- c("Height", "dbh", 
                              "Chl.", "Carotenoids", "Chl. a/b", "Chl. / xc", 
                              "C", "N", "C:N", "δ13C", "δ15N", "δ18O", "SLA", 
                              "Age", "Hegyi", "BAI80", "BAI05", "Rt12", 
                              "Rs12", "Rt17", "Rs17",
...
tiff("04_figures/36_02_Abialba_PCA_spots.tiff", units = "mm",
     width = 600, height = 300,
     res = 600, compression = "lzw")
biplot_cold + biplot_hot
dev.off()