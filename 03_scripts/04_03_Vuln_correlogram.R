...
clean_target <- clean_target %>% 
  ...
  dplyr::select(c(height, dbh, sla_22,
                  age, hegyi_index, mean_bai, mean_1980, mean_20, mean_15,
                  mean_10, mean_05, Rt12, Rt17, Rt22, Rs12, Rs17)) %>% 
  select(sort(names(.)))

colnames(clean_target) <- c("Age", "d.b.h.", "Hegyi Index", "Height",
                            "BAI 05 years", "BAI 10 years", "BAI 15 years", 
                            "BAI since 1980", "BAI 20 years", "BAI", 
                            "Rs 2012", "Rs 2017", "Rt 2012", "Rt 2017", "Rt 2022", 
                            "SLA")
...
tiff("04_figures/04_04_vuln_correlogram.tiff", units = "mm", 
