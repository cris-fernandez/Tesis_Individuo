...
bai80_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = mean_1980), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = mean_1980), col = "red", fill = "red",
...
bai05_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = mean_05), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = mean_05), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "B") +
...
rt12_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = Rt12), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = Rt12), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "C") +
  ylab("Rt 2012") + 
  spot_scale
...
rt17_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = Rt17), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = Rt17), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "D") +
  ylab("Rt 2017") + 
  spot_scale
...
rt22_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = Rt22), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = Rt22), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "E") +
  ylab("Rt 2022") + 
  spot_scale
...
rs12_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = Rs12), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = Rs12), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "F") +
  ylab("Rs 2012") + 
  spot_scale
...
rs17_dot <- ggplot(clean_target) + 
  geom_point(aes(x = mean_def_obs, y = Rs17), color = "black") + 
  geom_smooth(aes(x = mean_def_obs, y = Rs17), col = "red", fill = "red",
              method = "loess", se = TRUE, size = 1, alpha = 0.2) + 
  labs(tag = "G") +
  ylab("Rs 2017") + 
  spot_scale + 
