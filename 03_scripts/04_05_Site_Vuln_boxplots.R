...
box_dbh <- ggplot(clean_target) + 
  geom_boxplot(aes(x = pair_id, y = dbh, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_age <- ggplot(clean_target) + 
  geom_boxplot(aes(x = pair_id, y = age, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_hegyi <- ggplot(clean_target) + 
  geom_boxplot(aes(x = pair_id, y = hegyi_index, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_rt12 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = pair_id, y = Rt12, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_rt17 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = pair_id, y = Rt17, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_rt22 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = pair_id, y = Rt22, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_rs12 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = pair_id, y = Rs12, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_rs17 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = pair_id, y = Rs17, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
tiff("04_figures/04_05_Sites_Vuln1_boxplots.tiff", units = "mm", width = 600, height = 300,
...
tiff("04_figures/04_05_Sites_Vuln2_boxplots.tiff", units = "mm", width = 600, height = 150,
     res = 800, compression = "lzw")
