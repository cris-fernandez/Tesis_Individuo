...
tiff("04_figures/17_01_All_morpho3_boxplots.tiff", units = "mm", width = 300, height = 700,
     res = 400, compression = "lzw")
h_box / dbh_box / c_box / n_box / cn_box / sla_box / age_box / hegyi_box
dev.off()

tiff("04_figures/17_01_Select_morpho3_boxplots.tiff", units = "mm", width = 300, height = 700,
     res = 400, compression = "lzw")
