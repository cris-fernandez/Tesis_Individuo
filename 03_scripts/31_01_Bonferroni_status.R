...
status_pairs <- vars_df_long %>% 
  mutate(grupo1 = gsub("_coldspot|_hotspot", "", Group1),
         grupo2 = gsub("_coldspot|_hotspot", "", Group2),
...
write.csv(status_pairs, "02_clean_data/31_01_pvals_bonferroni_status.csv")