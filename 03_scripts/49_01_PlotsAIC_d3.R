...
tiff("04_figures/49_01_PlotsAIC_d3_morpho3.tiff", units = "mm", width = 400, height = 400,
...
tiff("04_figures/49_01_PlotsAIC_d3_physio3.tiff", units = "mm", width = 400, height = 400,
     res = 400, compression = "lzw")
wc_plot + chl_plot + chlab_plot + xc_plot + chlxc_plot + d13c_plot + d15n_plot + d18o_plot + 
  guide_area() + plot_layout(ncol = 3, guides = "collect")
dev.off()

tiff("04_figures/49_01_PlotsAIC_d3_whole.tiff", units = "mm", width = 400, height = 400,
     res = 400, compression = "lzw")
