...
h_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = height, fill = spot_status),
...
dbh_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = dbh, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
c_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = percent_c, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
n_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = percent_n, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
cn_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = percent_c / percent_n, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
sla_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = sla_22, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
age_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = age, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
hegyi_box <- ggplot(clean_target3) + 
  geom_boxplot(aes(x = sp_id, y = hegyi_index, fill = spot_status),
               outlier.size = 0.9, outlier.alpha = 0.2) + 
  scale_fill_manual(breaks = c("coldspot", "hotspot"),
                    values = c("coldspot" = "#2274A5",
                               "hotspot" = "#D71515"),
...
tiff("04_figures/17_01_All_morpho2_boxplots.tiff", units = "mm", width = 300, height = 700,
     res = 400, compression = "lzw")
h_box / dbh_box / c_box / n_box / cn_box / sla_box / age_box / hegyi_box
dev.off()

tiff("04_figures/17_01_Select_morpho2_boxplots.tiff", units = "mm", width = 300, height = 700,
     res = 400, compression = "lzw")
