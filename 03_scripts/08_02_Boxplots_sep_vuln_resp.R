...
box_chl_a <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = chlor_a_22, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_chl_b <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = chlor_b_22, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_cn <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = cn_ratio, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_d18o <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = leaf_d18o, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_bai <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = mean_bai, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_bai20 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = mean_20, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
box_bai15 <- ggplot(clean_target) + 
  geom_boxplot(aes(x = sp_id, y = mean_15, fill = sp_id, alpha = spot_status)) + 
  scale_fill_manual(breaks = c("Abialba", "Pinsylv", "Pinpine", "all"),
                    values = c("Abialba" = "#746fb2",
                               "Pinsylv" = "#1b9e77",
                               "Pinpine" = "#db5f02",
...
tiff("04_figures/08_02_vuln_boxplots.tiff", units = "mm", width = 600, height = 450,
...
tiff("04_figures/08_03_resp_boxplots.tiff", units = "mm", width = 600, height = 450,
     res = 400, compression = "lzw")
