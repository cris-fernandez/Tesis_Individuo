...
abies_plot <- ggplot(data = abies) + 
  geom_col(aes(x = year, y = 0.5 * mean_spei18), fill = "black", alpha = 0.2)  +
...
tiff("04_figures/04_02_sp_dendro_spei18.tiff", units = "mm", width = 700, height = 520,
